...
import com.alex.web.exception.ServerInternalErrorException;
...
public class ServiceMonitor {
     ...
     * in a type in the com.alex.service package or any sub-package
     * under that.
     */
     ...
     */
    @AfterThrowing(pointcut = "com.alex.monitor.ServiceMonitor.serviceLayer()", throwing = "e")
